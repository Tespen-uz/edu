...
const AboutPage = () => {
  return (
    <div className="w-full ">
      ...
      <div >
        <div
        style={{margiTop:"10px", background: `linear-gradient(143deg, rgba(0,245,255,0.6755077030812324) 0%, rgba(36,167,118,0.4766281512605042) 51%, rgba(32,166,92,0.5802696078431373) 100%)`  }} className="">
          <div 
         
           className="pt-24 relative h-a lg:flex px-5">
            <div className="absolute top-0 left-0 right-0">
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
  <path fill="#fff" fill-opacity="1" d="M0,96L40,106.7C80,117,160,139,240,128C320,117,400,75,480,69.3C560,64,640,96,720,117.3C800,139,880,149,960,165.3C1040,181,1120,203,1200,192C1280,181,1360,139,1400,117.3L1440,96L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path>
</svg>
      </div>
          ...
          <div
           ...
           className="pb-24 relative  h-a lg:flex px-5">
           <div className="container mx-auto  lg:flex ">
              <div
              style={{
                display: "flex",
