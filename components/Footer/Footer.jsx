...
const Footer = () => {
  return (
    <footer className=" bg-gray-100 pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
      <div className="container mx-auto ">
        <div className="flex flex-wrap ">
          <div className="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div className="w-full mb-10">
              <a className="inline-block max-w-[160px] mb-6">
          ...
          <div className="w-full sm:w-1/2 lg:w-2/12 px-4">
            <div className="w-full mb-10">
              <h4 className="text-gray-600 text-lg font-semibold mb-9">
                Resources
              </h4>
              <ul>
                <li>
              ...
              <div className="flex items-center mb-6">
                <a
                  className="
                     ...
                     justify-center
                     rounded-full
                     border border-[#E5E5E5] text-gray-600
