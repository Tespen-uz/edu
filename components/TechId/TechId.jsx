...
function TechId() {
    return (
        <div className='container p-2 mx-auto py-24 relative'>
            
            <div class="w-full border-4  rounded-xl flex flex-col justify-center items-center relative">
                ...
                <div class="text-center">
                    <p class="text-2xl capitalize  font-bold mb-2"><span className='text-gray-400 text-xl font-medium'>Name:</span> Falonchi Pistonchi</p>
                    <p class="text-lg text-gray-400 font-normal">Job: <span className='text-gray-800'>Maxsus</span></p>
                    <p class="text-lg text-gray-400 font-normal">Age: <span className='text-gray-800'>Maxsus</span></p>
                    <p class="text-lg text-gray-400 font-normal">Unversity: <span className='text-gray-800'>Maxsus</span></p>
                </div>
                <div className='w-full flex py-4 justify-center '>
                    ...
                    <a href=""className='mx-2 transition-all hover:scale-125'>
                        <svg fill='#0000FF' xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 16h-2v-6h2v6zm-1-6.891c-.607 0-1.1-.496-1.1-1.109 0-.612.492-1.109 1.1-1.109s1.1.497 1.1 1.109c0 .613-.493 1.109-1.1 1.109zm8 6.891h-1.998v-2.861c0-1.881-2.002-1.722-2.002 0v2.861h-2v-6h2v1.093c.872-1.616 4-1.736 4 1.548v3.359z"/></svg>
                    </a>
